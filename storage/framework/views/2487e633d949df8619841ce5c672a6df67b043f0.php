...
<form  action ="<?php echo e(route('truyen.store')); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" value="<?php echo e(old('tentruyen')); ?>" onkeyup="ChangeToSlug()" name="tentruyen" id="slug" aria-describedby="emailHelp" placeholder="Tên truyen...">
  </div>
  <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\New folder\htdocs\laravel8\laravel_sachtruyen\resources\views/admincp/truyen/create.blade.php ENDPATH**/ ?>