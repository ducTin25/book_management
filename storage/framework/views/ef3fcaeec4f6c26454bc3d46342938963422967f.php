...
<div class="row">
	<div class="col-md-9">
		<div class="row">
		<div class="col-md-3">
			<img class="card-img-top" src="<?php echo e(asset('public/uploads/truyen/'.$truyen->hinhanh)); ?>">
		</div>
		<div class="col-md-9">
			<style type="text/css">
				.infotruyen
			...
			<ul class="infotruyen">
				<li>Tên truyện: <?php echo e($truyen->tentruyen); ?></li>
				<li>Tác giả: <?php echo e($truyen->tacgia); ?></li>
				<li>Thể loại: <a href="<?php echo e(url('danh-muc/'.$truyen->danhmuctruyen->slug_danhmuc)); ?>"><?php echo e($truyen->danhmuctruyen->tendanhmuc); ?></a></li>
				<li>Số chapter: </li>
				<li>Lượt xem</li>
		...
		<ul class="mucluctruyen">
          ...
          <div class="card shadow-sm">
            <img class="card-img-top" src="<?php echo e(asset('public/uploads/truyen/1001dem70.jpg')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\New folder\htdocs\laravel8\laravel_sachtruyen\resources\views/pages/truyen.blade.php ENDPATH**/ ?>